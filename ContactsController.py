...
def displayContacts(contactlist:list):
    for contact in contactlist:
        ...
        contact_email = contact.getEmail() if  len(contact.getEmail())>0 else 'Мэйл не указан'
        contact_phone = contact.getPhone() if len(contact.getPhone())>0 else 'Теле не указан'
